    ...
    <section>
        <div class="container1 relative">
            <section class="hero panel">
                ...
                <div class="container flex justify-center z-[2]">
                ...
                <img class=" right-[0vh] top-[7vh] absolute z-[2] h-[78rem] w-[52rem]" src="~/assets/images/elements/giraffe.png" alt="giraffe">
