...
<template>
    <section>
        <div class="container1 relative z-[30]">
            <section class="hero panel relative z-[50]">
                 <div class="blurBackground"></div>
                <div class="navGradientTop"></div>
                <img class="blur-[2px] left-[17vh] top-[42vh] absolute z-[2]" src="~/assets/images/elements/elephant.png" alt="olifant">
                ...
                <img class=" right-[0vh] top-[7vh] absolute z-[3] h-[62.4rem] w-[41.6rem]" src="~/assets/images/elements/giraffe.png" alt="giraffe">

                <div class="navGradienBottom"></div>
            </section>

            <section class="hero panel z-[50]  relative">
                <div class="blurBackground2"></div>
                <div class="navGradientTop"></div>
                <img class="left-[17vh] top-[12.5vh] absolute z-[2]" src="~/assets/images/elements/astronaut.png" alt="astronaut">
            ...
            <section class="hero panel z-10 relative">
